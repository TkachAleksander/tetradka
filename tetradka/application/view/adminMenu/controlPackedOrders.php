   		...
   		<div class="row">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 floor-content">
				<div class="col-lg-offset-1 col-lg-10">
					...
					<p class="text-center topic-admin-panel"><b>Заказы на упаковку</b></p>
       				...
       				<?php foreach ($allOrders as $order) { ?>
    					<tr>
    						...
    						<td class="text-center">
                                ...
                                <img class="img-responsive img-send-to-packaging-admin" src="/img/admin/glyphicons-211-arrow-left.png" onclick="changeStatusOther('<?php echo $order->id;?>','обрабатывается')" title="Отправить в новые заказы">
                                <img class="img-responsive img-send-to-packaging-admin" src="/img/admin/glyphicons-212-arrow-right.png" onclick="changeStatusOther('<?php echo $order->id;?>','ожидает получателя')" title="Отправить в ожидание получателя">
                                <img class="img-responsive img-cancle-admin" src="/img/admin/delete.png" onclick="sendInOrderTable('<?php echo $order->id; ?>','orders','orders_cancle')" title="Переместить в отмененные">
    						</td>
    					</tr>
					<?php } ?>
       					<tr>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 floor-content">
                <div class="col-lg-offset-1 col-lg-10">
                    ...
                    <p class="text-center topic-admin-panel"><b>Заказы в ожидании получателя</b></p>
                    <table class="table table-bordered table-orders">
                        <tr id="th-basket" class="active">
                            <th class="text-center">№</th>
                            <th class="text-center">Имя</th>
                    ...
                    <?php foreach ($secondAllOrders as $order) { ?>
                        <tr>
                            <td class="text-center"><?php echo $order->id; ?></td>
                            <td class="text-center"><?php echo $order->f_name; ?></td>
                            <td class="text-center"><?php echo $order->l_name; ?></td>
                            ...
                            <td class="text-center">
                                <img class="img-responsive img-more-admin" src="/img/admin/glyphicons-30-notes-2.png" onclick="moreAboutOrder('<?php echo $order->id; ?>')" data-toggle="modal" data-target="#more-about-order" title="Подробнее">
                                <img class="img-responsive img-send-to-packaging-admin" src="/img/admin/glyphicons-207-ok.png" onclick="changeStatusOther('<?php echo $order->id;?>','выполнен')" title="Отправить в выполненые">
                                <img class="img-responsive img-cancle-admin" src="/img/admin/delete.png" onclick="sendInOrderTable('<?php echo $order->id; ?>','orders','orders_cancle')" title="Переместить в отмененные">
                            </td>
                        </tr>
                    <?php } ?>
