   		...
   		<div class="row">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 floor-content">
				<div class="col-lg-offset-1 col-lg-10">
					...
					<p class="text-center topic-admin-panel"><b>Новые заказы</b></p>
                ...
                <td class="text-center"><?php echo $order->order_time; ?></td>
                  ...
                  <img class="img-responsive img-send-to-packaging-admin" src="/img/admin/glyphicons-212-arrow-right.png" onclick="changeStatusOther('<?php echo $order->id;?>','собирается')" title="Отправить в заказы на упаковку">
                  <img class="img-responsive img-send-to-packaging-admin" src="/img/admin/glyphicons-21-home.png" onclick="changeStatusOther('<?php echo $order->id;?>','доставка на дом')" title="Доставка на дом">
  	...
  	<div class="modal-dialog">
  	  	<div class="modal-content">
  	  	  	...
  	  	  	<div class="modal-body">
  	  	  		<table class="table table-bordered table-adm-more">
  	  	  			<tbody>
  	  	  				<tr class="active">
							       <th>Имя</th>
							       <th>Фото</th>
