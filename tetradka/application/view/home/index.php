      		...
      		<div class="col-lg-offset-1 col-lg-10 floor-about hidden-xs">
				<div class="row" >
					<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 pull-right">
						...
						<p class="logo-text-index PatuaOne text-center">Tetradka</p>
						<div class="index Philosopher"><h1>Интернет-магазин канцтоваров ориентированный на мелкий опт. </h1></div>
